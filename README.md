...
Property attributes should be explicitly listed, and will help new programmers when reading the code.  The order of properties should be atomicity then storage ([matching Apple's style](https://developer.apple.com/library/ios/navigation/#section=Resource%20Types&topic=Sample%20Code)).
...
```objc
@interface Airplane
+ (instancetype)airplaneWithType:(TTDAirplaneType)type;
@end
```
